...
public class LoginActivity extends AppCompatActivity {
    ...
    Button btnEntrar, forgotPasswordButton ;
    FirebaseAuth auth;
    ...
    private void sendPasswordResetEmail() {
        ...
        if (TextUtils.isEmpty(email)) {
            // Se o campo de e-mail estiver vazio, exiba um aviso
            Toast.makeText(this, "Por favor, preencha seu e-mail antes de solicitar a redefinição de senha.", Toast.LENGTH_SHORT).show();
        } else {
            ...
            Toast.makeText(this, "Um e-mail de redefinição de senha foi enviado para " + email, Toast.LENGTH_SHORT).show();
        }
    }
